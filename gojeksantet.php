...
$headers[] = 'X-Location: -6.405821,106.064193';
        echo "\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\e[92m|            THANKS TO Dio Alief Utama           |\n";
        echo "\e[92m|            Thank you for CEO GOJEK NADIEM      |\n";
        echo "\e[92m|     https://github.com/gojekhappy/nikmatin     |\n";
        echo "\e[92m|   SCRIPT GOJEK AUTO REGIST + AUTO SAVE TOKEN   |\n";
        echo "\e[92m|            GOODLUCK Selamat Makan              |\n";
        echo "\e[92m--------------------------------------------------\n";
        echo "\n";
        ulang:
